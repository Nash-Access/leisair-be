...
from leisair_ml.utils import TryExcept
from leisair_ml.utils.dataloaders import exif_transpose, letterbox
...
from leisair_ml.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(
        ...
        if pt:  # PyTorch
            ...
            from leisair_ml.utils.triton import TritonRemoteModel
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from leisair_ml.utils.export import export_formats
        from leisair_ml.utils.downloads import is_url
