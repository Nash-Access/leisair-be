...
from leisair_ml.utils import TryExcept, emojis
from leisair_ml.utils.downloads import curl_download, gsutil_getsize
from leisair_ml.utils.metrics import box_iou, fitness
...
def strip_optimizer(f='best.pt', s=''):  # from leisair_ml.utils.general import *; strip_optimizer()
