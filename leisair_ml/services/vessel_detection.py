...
from leisair_ml.models.common import DetectMultiBackend
from leisair_ml.utils.dataloaders import (
    IMG_FORMATS,
    VID_FORMATS,
    LoadImages,
    LoadScreenshots,
...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        # pred = leisair_ml.utils.general.apply_classifier(pred, classifier_model, im, im0s)
